def list_merge_dedup_py3(input_1=None, input_2=None, input_3=None, input_4=None, input_5=None, input_6=None, input_7=None, input_8=None, input_9=None, input_10=None, **kwargs):
    """
    ...
    list_to_dedup = outputs
    outputs = list({frozenset(list(item.items())) : item for item in list_to_dedup}.values()) 
    phantom.debug("deduped results: {}".format(outputs))
